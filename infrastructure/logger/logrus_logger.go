// Package logger provides logging implementation using logrus for the OCR checker application.
// It implements the domain logging interface with structured logging capabilities.
package logger
