...
func (f *transmissionFetcher) FetchByRounds(ctx context.Context, contractAddress common.Address, startRound, endRound uint32) (*entities.TransmissionResult, error) {
	...
	for _, tx := range transmissions {
		roundID := uint32(tx.Epoch)<<8 | uint32(tx.Round)
...
func (f *transmissionFetcher) FetchByBlocks(ctx context.Context, contractAddress common.Address, startBlock, endBlock uint64) (*entities.TransmissionResult, error) {
	...
	if len(transmissions) > 0 {
		startRound = uint32(transmissions[0].Epoch)<<8 | uint32(transmissions[0].Round)
		endRound = uint32(transmissions[len(transmissions)-1].Epoch)<<8 | uint32(transmissions[len(transmissions)-1].Round)
	}
...
func (f *transmissionFetcher) FetchByTimeRange(ctx context.Context, contractAddress common.Address, startTime, endTime time.Time) (*entities.TransmissionResult, error) {
...
func (f *transmissionFetcher) fetchTransmissionsInRange(ctx context.Context, contractAddress common.Address, startBlock, endBlock uint64) ([]entities.Transmission, error) {
